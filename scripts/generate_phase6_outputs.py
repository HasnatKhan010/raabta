...
REQUIRED = (
    ...
    "reports/tables/retrieval_ablations.json",
)
...
def main() -> None:
    ...
    command = [
        ...
        "--diagnostic",
        "data/diagnostic/raabta_diagnostic.csv",
        "--passages",
        ...
        "work/reranker_depth20_checkpoint.jsonl",
        "--robustness-output",
        "reports/tables/robustness.json",
        "--failures-output",
        "reports/error_analysis/failures_30.csv",
        "--figures-dir",
        "reports/figures",
        "--latency-output",
        "reports/tables/latency_resources.json",
        "--embedding-manifest",
        "artifacts/metadata/e5_small_150_30.json",
        "--baseline-report",
        "reports/tables/baselines_development.json",
        "--querybridge-report",
        "reports/tables/querybridge_development.json",
        "--reranker-report",
        "reports/tables/reranker_depth20.json",
        "--reranker-benchmark",
